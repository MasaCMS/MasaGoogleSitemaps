...
*/
	...
	variables.framework.package = 'MasaGoogleSitemaps';
	variables.framework.packageVersion = '4.3.0';
	...
	variables.framework.action = 'gsm';
	...
	variables.framework.preserveKeyURLKey = 'gsmpk';
